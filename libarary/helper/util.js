 ...
 * @Last Modified time: 2018-10-08 11:23:32
 */
 ...
 */
export function alert(msg = '提示', type = 'success', showClose = false) {
...
export function confirm(msg = '提示', title = '提示', type = 'info', successCallBack = () => {}, errorCallBack = () => {}) {
  Alert('confirm', msg, title, type, successCallBack, errorCallBack)
}
...
export function notify(msg = '提示', title = '提示', type = 'success') {
  Notification('notify', msg, title, type)
}
...
export function downloadFile(url = '', param = {}, methods = 'get') {
  const axios = Axios.create({
    responseType: 'blob',
    headers: {
      Token: cache.get(config.cache['USER_INFO'], 'session').token,
