<template>
  <div :placement="placement">
    ...
    <transition name="slide-out" v-on:enter="d_enter">
      <div v-if="isVisibleDock" ref="dock" class="dock" :style="_style(0)" :class="_class(0)">
        <transition-group name="slide-out" v-on:before-leave="s_beforeLeave" v-on:afterLeave="s_afterLeave">
          <section v-for="(isVisible, i) in isVisibleSections" v-if="isVisible" ref="section" class="panel" :key="'k'+i" :style="_style(i+1)" :class="_class(i+1)">
            ...
            <a href="#" class="action-close" :style="_style(3)" :class="_class(3)" @click.prevent="close(i)" v-html="closeHtml">
            </a>
            <a v-if="count==2 && !isShifted && i==0" href="#" class="action-extra" :style="_style(4)" :class="_class(4)" @click.prevent="closeAll" v-html="closeAllHtml">
            </a>
            <a v-if="isShifted && i==0" href="#" class="action-extra" :style="_style(4)" :class="_class(4)" @click.prevent="expand" v-html="extraHtml">
            </a>
          </section>
        </transition-group>
      </div>
...
<script>
// 参考 https://github.com/lyollix/vue-slideout-panel
/* eslint-disable */
...
[placement='left'] .slide-out-enter,
[placement='left'] .slide-out-leave-to {
  transform: translateX(-100%);
}
